...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # Kết nối sự kiện click đúng với tên widget trong Object Inspector
        self.ui.btn_key.clicked.connect(self.call_api_gen_keys)
        self.ui.btn_en.clicked.connect(self.call_api_encrypt)
        self.ui.btn_de.clicked.connect(self.call_api_decrypt)
        self.ui.btn_sign.clicked.connect(self.call_api_sign)
        self.ui.btn_verife.clicked.connect(self.call_api_verify)
